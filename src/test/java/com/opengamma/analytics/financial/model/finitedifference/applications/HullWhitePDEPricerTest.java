...
public class HullWhitePDEPricerTest {
  ...
  public void HullWhiteTest() {
    ...
    final MeshingFunction tMesh = new ExponentialMeshing(0, T, tSteps, -3.5);
    ...
    //System.out.println(pdePrice1*SandBox.price(0d, T, r0));
    System.out.println(pdePrice1);
    System.out.println(SandBox.price(0d, (double)T, r0));
