 ...
 */
public class HullWhiteBoundaryCondition implements BoundaryCondition {
   ...
   */
  public HullWhiteBoundaryCondition(final Function1D<Double, Double> timeValue, final double level, final boolean isLower) {
  ...
  public HullWhiteBoundaryCondition(final double fixedValue, final double level, final boolean isLower) {
